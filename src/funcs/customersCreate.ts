...
export function customersCreate(
  ...
  Result<
    ...
    | errors.CreateUnprocessableEntity
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CustomerRequest$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "405", "409", "422", "429", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr(409, errors.DuplicateError$inboundSchema),
    M.jsonErr(422, errors.CreateUnprocessableEntity$inboundSchema),
