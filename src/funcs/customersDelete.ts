...
> {
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "404", "405", "422", "429", "4XX", "500", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomerDeleteResponse$inboundSchema),
    ...
    M.jsonErr(422, errors.DeleteUnprocessableEntity$inboundSchema),
