...
export function customersUpdate(
  ...
  Result<
    ...
    | errors.UpdateUnprocessableEntity
...
> {
  ...
  const body = encodeJSON("body", payload.CustomerRequest, { explode: true });
  ...
  >(
    ...
    M.jsonErr(422, errors.UpdateUnprocessableEntity$inboundSchema),
